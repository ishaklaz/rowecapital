...
// Database setup
const db = new sqlite3.Database('./rowecapital.db', (err) => {
    if (err) {
...
app.get('/deposit-usdt', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'deposit-usdt.html'));
});

app.get('/deposit-tron', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'deposit-tron.html'));
});

app.get('/deposit-btc', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'deposit-btc.html'));
});
